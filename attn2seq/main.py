...
from model import Encoder, AttnDecoderRNN
...
parser.add_argument('--data_path', type=str, default='/scratch/zc807/attn2seq', metavar='PATH',
                    help='data path of pairs.pkl and lang.pkl (default: /scratch/zc807/attn2seq)')
parser.add_argument('--save_data_path', type=str, default='/scratch/zc807/attn2seq', metavar='PATH',
                    help='data path to save model parameters (default: /scratch/zc807/attn2seq)')
...
def evaluate(encoder, decoder, sentence, input_lang, output_lang, args):
    ...
    with torch.no_grad():
        ...
        decoder_hidden = decoder.init_hidden(batch_size=1)
