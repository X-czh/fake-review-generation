...
parser.add_argument('--save-data-path', type=str, default='/scratch/zc807/seq2seq_attn', metavar='PATH',
                    help='data path to save pairs.pkl and lang.pkl (default: /scratch/zc807/seq2seq_attn)')
