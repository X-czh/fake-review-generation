...
class TargetLSTM(nn.Module):
    ...
    def forward(self, x):
        ...
        out, _ = self.lstm(emb, (h0, c0)) # out: batch_size * hidden_dim
    ...
    def step(self, x, h, c):
        ...
        out = self.log_softmax(self.fc(out.view(-1, self.hidden_dim))) # batch_size * vocab_size
        return out, h, c
    ...
    def sample(self, batch_size, seq_len):
        ...
        for _ in range(seq_len):
            ...
            x = torch.multinomial(torch.exp(out), 1)
            samples.append(x)
